...
public class SearchService {
    ...
    //查询淘淘索引库
    public SearchResult queryItemListByKeyWords(String keywords, Integer pageNum, Integer pageSize) throws SolrServerException {
        ...
        //构建searchResult
        SearchResult searchResult = new SearchResult(queryResponse.getResults().getNumFound(), items);
        return searchResult;
    }
}
